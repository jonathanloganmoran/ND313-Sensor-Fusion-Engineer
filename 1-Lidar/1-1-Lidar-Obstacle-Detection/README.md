...
* ⬜️ Use PCL to render the "segmented" LiDAR point clouds generated by the custom segmentation function for the _"Project 1.1" scene_ (see commit [``]() for reference);
